package com.task1.number_guessing_game;
...
System.out.println("It's a concept of number guessing game");
System.out.println(" It consists of two rounds");
System.out.println("To start the game press 1 \nTo exit Press 0 ");
int startinput = sc.nextInt();
while (!(startinput == 1) && !(startinput == 0)) {
    System.out.println(" Input Is Invalid! To start the game press 1 \n To exit Press 0 ");
...
while (!(attempts == 5) && !(attempts == 10)) {
    System.out.println(" Entry Is Invalid!  Select the maximum number of attemps you want (5/10)");
    attempts = sc.nextInt();
}
if (attempts == 5) {
    score = 40;
System.out.println("If you make wrong attempt, points will be deducted by 2");
int i = 1;
while (i < attempts) {
