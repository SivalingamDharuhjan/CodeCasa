...
package com.task2.onlinereservationsystem;
...
bookings.put(username, reservationDetails);
...
for (String username : bookings.keySet()) {
    String reservationDetails = bookings.get(username);
...
if (bookings.containsKey(username)) {
    System.out.println("------------------------------------------------------");
    System.out.println("Your current reservation: " + bookings.get(username));
